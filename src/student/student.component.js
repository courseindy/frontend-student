...
export default class StudentComponent extends React.Component {
  ...
  handleSubmit = async (event) => {
    ...
    if (this.state.student_name == null || this.state.student_name == '') {
      this.setState({ errorName: "Input Student name" })
      inputName = true;
    } else {
    ...
    if (this.state.student_lastname == null || this.state.student_lastname == '') {
      this.setState({ errorLastname: "Input Student Last name" })
      inputLastname = true
    } else {
              ...
              <tbody>
                {this.state.pages.map(page => (
                  <tr>
                    ...
                    <td><button type="button" onClick={this.handleDeleteClick(page._id)} class="btn btn-danger btn-flat btn-sm"><i calss="far fa-trash-alt">&nbsp; delete</i></button></td>
                  </tr>
                ))}
              </tbody>
              {/*<tfoot>
